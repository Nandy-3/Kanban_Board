...
export default function TaskModal({ task, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-fade-in-up">
            <div className="bg-[#1e1e2e]/95 border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)] w-full max-w-md overflow-hidden relative" onClick={e => e.stopPropagation()}>
